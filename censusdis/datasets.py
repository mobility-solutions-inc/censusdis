...
DATASET_REFERENCE_URLS = {
    ...
    ACS1_CPROFILE: "http://api.census.gov/data/2024/acs/acs1/cprofile",
    ACS1_PROFILE: "http://api.census.gov/data/2024/acs/acs1/profile",
    ACS1_PUMS: "http://api.census.gov/data/2024/acs/acs1/pums",
    ACS1_PUMSPR: "http://api.census.gov/data/2024/acs/acs1/pumspr",
    ACS1_SDATAPROFILE_CD119: "http://api.census.gov/data/2023/acs/acs1/sdataprofile/cd119",
    ACS1_SPP: "http://api.census.gov/data/2024/acs/acs1/spp",
    ACS1_SUBJECT: "http://api.census.gov/data/2024/acs/acs1/subject",
    ...
    ACS5: "http://api.census.gov/data/2024/acs/acs5",
    ...
    CPS_BASIC_NOV: "http://api.census.gov/data/2025/cps/basic/nov",
    CPS_BASIC_OCT: "http://api.census.gov/data/2024/cps/basic/oct",
    CPS_BASIC_SEP: "http://api.census.gov/data/2025/cps/basic/sep",
    ...
    CPS_FOODSEC_DEC: "http://api.census.gov/data/2024/cps/foodsec/dec",
    ...
    CPS_SCHOOL_OCT: "http://api.census.gov/data/2024/cps/school/oct",
    ...
    ECN_BRANDDEAL: "http://api.census.gov/data/2022/ecnbranddeal",
    ...
    ECN_CRFIN: "http://api.census.gov/data/2022/ecncrfin",
    ...
    ECN_ELMENU: "http://api.census.gov/data/2022/ecnelmenu",
    ECN_EMPFUNC: "http://api.census.gov/data/2022/ecnempfunc",
    ECN_ENTSUP: "http://api.census.gov/data/2022/ecnentsup",
    ...
    ECN_EXPBYAUX: "http://api.census.gov/data/2022/ecnexpbyaux",
    ...
    ECN_GRANT: "http://api.census.gov/data/2022/ecngrant",
    ...
    ECN_HOSP: "http://api.census.gov/data/2022/ecnhosp",
    ...
    ECN_KOB: "http://api.census.gov/data/2022/ecnkob",
    ...
    ECN_PATIENT: "http://api.census.gov/data/2022/ecnpatient",
    ...
    ECN_PURELEC: "http://api.census.gov/data/2022/ecnpurelec",
    ECN_PURGAS: "http://api.census.gov/data/2022/ecnpurgas",
    ECN_PURMODE: "http://api.census.gov/data/2022/ecnpurmode",
    ECN_RDACQ: "http://api.census.gov/data/2012/ecnrdacq",
    ECN_RDOFC: "http://api.census.gov/data/2022/ecnrdofc",
